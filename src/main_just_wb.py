...
class FairFaceDataset(Dataset):
    def __init__(self, csv_file, img_dir, transform=None):
        ...
        self.data = self.data[self.data['race'].isin(['White', 'Black'])].reset_index(drop=True) # atualizar os indices apos remoção das outras raças
        # ver quantas instancias temos para as duas raças
...
torch.save(model.state_dict(), "models/model_black&white_base.pth")
print("Model saved")
